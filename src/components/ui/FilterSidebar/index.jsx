  ...
  return (
    <aside className="glass-panel rounded-[2rem] p-5">
      <div className="flex items-center justify-between">
        <div className="text-lg font-semibold text-ink">Фильтры</div>
        <button
          type="button"
      ...
      <div className="mt-6 space-y-6">
        <div>
          <div className="mb-3 text-sm font-semibold text-ink">Категория</div>
          <select
            value={filters.category}
            onChange={(event) => setFilter('category', event.target.value)}
            className="h-11 w-full rounded-2xl border border-line bg-white px-4"
          >
        ...
        <div>
          <div className="mb-3 text-sm font-semibold text-ink">Бренд</div>
          <select
            value={filters.brand}
        ...
        <div>
          <div className="mb-3 text-sm font-semibold text-ink">Цена</div>
          <div className="grid grid-cols-2 gap-3">
            <input
              type="number"
              value={filters.minPrice}
              onChange={(event) => setFilter('minPrice', Number(event.target.value))}
              className="h-11 rounded-2xl border border-line px-4"
              placeholder="От"
            />
            <input
              type="number"
        ...
        <div>
          <div className="mb-3 text-sm font-semibold text-ink">Рейтинг от</div>
